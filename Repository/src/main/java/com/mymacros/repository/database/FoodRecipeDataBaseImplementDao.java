...
public class FoodRecipeDataBaseImplementDao implements FoodRecipeRepositoryDao {
      ...
      */
     @Override
     public List<FoodRecipeDto> getAllFoodRecipe(long idUser)
     {
          return this.foodRecipeDatabase.keySet()
                  .stream()
                  .map(this.foodRecipeDatabase::get)
                  .filter(foodRecipeDto -> foodRecipeDto.getId() == idUser)
